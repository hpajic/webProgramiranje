...
<div class="row">
    ...
    if(isset($_REQUEST['addcategory'])){
        if($_REQUEST['addcategory'] == "success"){
            echo "<div class='alert alert-success'><strog>Success</strong> Category Added!</div>";
        }
        else if($_REQUEST['addcategory'] == "error"){
            echo "<div class='alert alert-danger'><strog>Error</strong> Category Was Not Added!</div>";
        }
    }
